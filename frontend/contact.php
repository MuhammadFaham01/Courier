          ...
          <div class="row">
            ...
            <div class="col-md-6 col-lg-5 d-flex flex-center">
              <div class="card-body">
                ...
                <p class="text-700 my-4"> <i class="fas fa-map-marker-alt text-warning me-3"></i><span>SD-1, Block A North Nazimabad Town, Karachi, 74700</span></p>
                ...
                <p><i class="fas fa-envelope text-warning me-3"> </i><a class="text-700"
                    href="mailto:vctung@outlook.com"> info@courier.com</a></p>
                <ul class="list-unstyled list-inline mt-5">
                  <li class="list-inline-item"><a class="text-decoration-none" href="https://www.facebook.com/"><i
                        class="fab fa-facebook-square fs-2"></i></a></li>
                  <li class="list-inline-item"><a class="text-decoration-none" href="https://www.instagram.com/"><i
                        class="fab fa-instagram-square fs-2"></i></a></li>
                  <li class="list-inline-item"><a class="text-decoration-none" href="https://twitter.com/"><i
